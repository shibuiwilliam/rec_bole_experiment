...
class TestModelTrainer:
    ...
    def test_train_single_model_default_metrics(self, mocker):
    ...
    def test_compare_models_auto_metrics(self, mocker):
    ...
    def test_display_results_empty(self, mocker):
    ...
    def test_display_results_with_descriptions(self, mocker):
        """Test display results includes model descriptions"""
        mock_get_descriptions = mocker.patch(
